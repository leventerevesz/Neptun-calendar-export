...
#pragma endregion
		...
		List<Tanora^> ^parseSourceFile(String ^filename) {
			// A forr�sf�jlb�l csin�l egy List<Tanora^> list�t. Egy Labelbe ki�rja mit v�laszottunk.
			//
			...
			// Az oralista lesz a visszaadott �rt�k, az egy h�tnyi �rarend
			...
			// Dialog init
				...
				while (!sreader->EndOfStream) {
					...
					if (sor->Length > 0) {
						...
						// N�ha az oktat� hely�re a terem ker�l (a Neptunt�bl�zat miatt), de ez nem zavar�
